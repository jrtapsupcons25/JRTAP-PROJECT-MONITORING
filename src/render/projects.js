...
export async function renderProjects() {
  ...
  content.innerHTML = projects.length === 0
    ? `<div class="card empty">${ICONS.projects}<div class="lead">No projects yet</div>${approver ? 'Create one with "New project" above.' : 'Ask the Owner or Admin to create a project.'}</div>`
